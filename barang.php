					...
					<form action="processbarang.php?do=add" method="POST" id="formbarang">
						...
						<div class="modal-body">
							<div class="form-group row">
								<label for="kodebarang" class="col-sm-4 col-form-label">Kategori</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="Kategori" id="kodebarang" name="kodebarang">
								</div>
							</div>
					...
					<form action="processmutasi.php?do=add" method="POST" id="formmutasiform">
						...
						<div class="modal-body">
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" placeholder="Kategori" id="kodemutasibarang" name="kodemutasibarang" disabled>
									</div>
								</div>
