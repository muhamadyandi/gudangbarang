			...
			<div class="card-deck">
				<div class="card bg-light">
					...
					<div class="card-body">
						...
						<p class="card-text" align="justify">Halaman ini memuat Daftar Barang beserta fitur CRUD. Jumlah total barang yang tercatat saat ini adalah : </p>
				...
				<div class="card bg-light">
					...
					<div class="card-body">
						...
						<p class="card-text" align="justify">Halaman ini memuat Daftar Supplier beserta fitur CRUD. Banyak supplier yang sudah terdaftar : </p>
				...
				<div class="card bg-light">
					...
					<div class="card-body">
						...
						<p class="card-text" align="justify">Mencatat mutasi barang yang keluar dari gudang dan data dapat dicetak ke Excel. Jumlah total mutasi yang telah dilakukan hingga saat ini adalah : </p>
